...
import { listSkills, deleteSkill, moveSkill } from "@/features/skill/actions";
            ...
            {items.map((item, index) => (
              ...
              >
                <td className="p-4">
                  <OrderButtons
                    moveAction={(direction) =>
                      moveSkill.bind(null, direction, item.id)
                    }
                    disableUp={index === 0}
                ...
                <td className="space-x-4 p-4 text-right">
                  ...
                  <DeleteButton action={deleteSkill.bind(null, item.id)} />
                </td>
              </tr>
            ))}
            {items.length === 0 && (
